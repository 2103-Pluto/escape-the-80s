...
export default class SynthwaveScene extends Phaser.Scene {
  ...
  preloadSoldier() {
    ...
    this.load.spritesheet(
      `${this.color}SoldierRunning`,
      `assets/spriteSheets/${this.color}/Gunner_${this.color}_Run.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    //Idle Soldier
    this.load.spritesheet(
      `${this.color}SoldierIdle`,
      `assets/spriteSheets/${this.color}/Gunner_${this.color}_Idle.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    //Jumping Soldier
    this.load.spritesheet(
      `${this.color}SoldierJumping`,
      `assets/spriteSheets/${this.color}/Gunner_${this.color}_Jump.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    //Dying Soldier
    this.load.spritesheet(
      `${this.color}SoldierDying`,
      `assets/spriteSheets/${this.color}/Gunner_${this.color}_Death.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    //Crouching Soldier
    this.load.spritesheet(
      `${this.color}SoldierCrouching`,
      `assets/spriteSheets/${this.color}/Gunner_${this.color}_Crouch.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    this.load.spritesheet(
      `RedSoldierRunning`,
      `assets/spriteSheets/Red/Gunner_Red_Run.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    this.load.spritesheet(
      `RedSoldierIdle`,
      `assets/spriteSheets/Red/Gunner_Red_Idle.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    this.load.spritesheet(
      `RedSoldierJumping`,
      `assets/spriteSheets/Red/Gunner_Red_Jump.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    this.load.spritesheet(
      `RedSoldierDying`,
      `assets/spriteSheets/Red/Gunner_Red_Death.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
    ...
    this.load.spritesheet(
      `RedSoldierCrouching`,
      `assets/spriteSheets/Red/Gunner_Red_Crouch.png`,
      {
        frameWidth: 48,
        frameHeight: 48,
      }
  ...
  preload() {
    ...
    this.load.image(
      "mountains",
      "assets/backgrounds/synthwave_scene/mountains.png"
    );
    this.load.image(
      "palms-back",
      "assets/backgrounds/synthwave_scene/palms-back.png"
    );
    ...
    this.load.audio(
      "background-music",
      "assets/audio/synthwave_scene/synthwave-palms.wav"
    );
  ...
  createGround(tileWidth, count) {
    ...
    for (let i = 0; i < count; i++) {
      let newGround = this.groundGroup
        .create(i * tileWidth, height, "road")
        .setOrigin(0, 1)
        .setScale(3.5)
        .refreshBody();
    }
  ...
  createBackgroundElement(imageWidth, texture, count, scrollFactor) {
    ...
    for (let i = 0; i < count; i++) {
      this.add
        .image(i * imageWidth, height, texture)
        .setOrigin(0, 1)
        .setScale(3.5)
  ...
  create() {
    ...
    this.sky = this.add
      .image(width * 0.5, height * 0.46, "sky")
      .setOrigin(0.5)
      .setScale(3.5)
      .setScrollFactor(0);
    ...
    this.physics.world.setBounds(
      ...
      false,
      false
    ); //set world bounds only on sides
  ...
  timer() {
    ...
    this.timerLabel = this.add
      .text(
        screenCenterX,
        screenCenterY - 250,
        "Time:" + this.formatTime(this.winTime),
  ...
  createAnimations() {
    ...
    this.anims.create({
      ...
      frames: this.anims.generateFrameNumbers(`${this.color}SoldierCrouching`, {
        start: 3,
      }),
      repeat: 0,
    });

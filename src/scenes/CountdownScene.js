...
export default class Countdown extends Phaser.Scene {
  ...
  countingDown(){
    this.raceSound.play()
      ...
      this.instructions = this.add.text(screenCenterX, screenCenterY - 50, 'First to the flagpole wins!!!', { fontFamily: '"Press Start 2P"' }).setFontSize(20).setOrigin(0.5)
      this.countDownText = this.add.text(screenCenterX, screenCenterY, 
        'Start Race in:' + this.initialTime, { fontFamily: '"Press Start 2P"' }).setFontSize(40).setOrigin(0.5)
